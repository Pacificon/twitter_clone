        ...
        <div className='w-screen h-screen flex items-center justify-center'>
            <div className='flex items-center justify-evenly w-[80%]'>
                ...
                <div>
                    ...
                    <form onSubmit={submitHandler} className='flex flex-col w-[55%]' action="">
                        {
                            !isLogin && (<>
                        ...
                        <h1>{isLogin ? "Do not have an account?" : "Already have an account?"} <span onClick={loginSignupHandler} className='font-bold text-[#1D9BF0] cursor-pointer'>{isLogin ? "Sign Up" : "Login"}</span></h1>
                    </form>
                </div>
            </div>
        </div >
